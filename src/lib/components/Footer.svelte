<footer class="**:[svg]:w-6 **:[svg]:h-6 **:[svg]:fill-slate-400 **:[svg]:hover:fill-slate-300">
	<ul class="grid grid-flow-col gap-4 p-4 place-content-start">
		<li>
			<a href="https://github.com/Thiagolino8/pokemon-unfuse" aria-label="GitHub">
		...
		<li>
			<a href="https://twitter.com/Thiagolinog" aria-label="Twitter">
		...
		<li>
			<a href="https://www.linkedin.com/in/thiago-lino-gomes-5812581bb" aria-label="LinkedIn">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
					<path
